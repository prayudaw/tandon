   ...
   <div id="content-wrapper" class="d-flex flex-column">
       ...
       <div id="content">
           ...
           <div class="container-fluid">
               ...
               <p class="mb-4" style="font-size:20px;font-weight: bold;">Monitoring Peminjaman Tandon hanya menampilkan
                   transaksi
                   peminjaman dan pengembalian hari
                   ini.
               </p>
               <!-- DataTales Example -->
               <div class="card shadow mb-4">
                   <div class="card-header py-3">
                       <h4 class="m-0 font-weight-bold text-primary">Total Peminjaman Buku Hari Ini :
                           <b><?php echo $jumlahBelumKembali ?></b>
                       </h4>
                   </div>
                   <div class="card-body">
                       <div class="table-responsive">
                           <table class="table table-bordered" id="table" width="100%" cellspacing="0">
                               ...
                               <tbody>
                                   <?php  foreach ($getTransaksiNow as $v) { ?>
                                   <tr>
                                       ...
                                       <td><?php echo $v['tgl_kembali'] ?></td>
                                       <td><?php echo $v['op_kembali'] ?></td>
                                   </tr>
                                   <?php }?>
